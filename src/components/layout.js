  ...
  <StaticQuery
    ...
    render={data => (
      <>
        ...
        <a href="https://github.com/mgechev/revive" className="github-corner" aria-label="View source on GitHub">
          <svg width="80" height="80" viewBox="0 0 250 250" className="octocat-corner" aria-hidden="true">
